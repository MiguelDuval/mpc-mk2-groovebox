...
ACTIVITY="com.miguelduval.mpcmk2groovebox/.MainActivity"
...
dump_ui() {
  adb shell uiautomator dump /sdcard/mpc-groovebox-ui.xml >/dev/null
  adb exec-out cat /sdcard/mpc-groovebox-ui.xml > "$DUMP"
}
